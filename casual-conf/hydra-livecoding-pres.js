...
shape(2)
  ...
  .layer(
    text(line0).scroll(0.18, 0.5).scale(0.3).mask(shape(4).scroll(1.04, 1.25)),
  )
  .layer(
    text(line1).scroll(0.18, 0.3).scale(0.3).mask(shape(4).scroll(1.04, 1.23)),
  )
  .layer(
    text(line2).scroll(0.18, 0.1).scale(0.3).mask(shape(4).scroll(1.04, 1.16)),
  )
  .layer(
    text(line3).scroll(0.18, 0.9).scale(0.3).mask(shape(4).scroll(1.04, 1.1)),
  )
  .out();
